...
tag='TagSet=[{Key=Owner,Value="MSR"},{Key=Terraform,Value="true"},{Key="Purpose",Value="Web-infra-POC"}]'
db_tag='[{"Key":"Owner","Value":"MSR"},{"Key":"Terraform","Value":"true"},{"Key":"Purpose","Value":"Web-infra-POC"}]'
